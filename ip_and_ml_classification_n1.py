...
'''
This sxcript contains an example of how to train a neural network to predict the posterior probability of a layer interface, as described in the paper:
...
#
# Tensorboard 
#   tensorboard --logdir=logs_A_M3 
#   tensorboard --logdir=logs_B_M3 
#   tensorboard --logdir=logs_C_M3 
